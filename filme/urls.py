# url - view - template sempre que for criar uma pagina tem que fazer isso 
...
urlpatterns = [
    ...
    path('logout/', auth_view.LogoutView.as_view(template_name='logout.html', http_method_names=['get', 'post', 'options']), name='logout'),
